...
<FunFact>
Training a frontier language model can cost hundreds of millions of pounds in computing power alone. The training loop runs across thousands of specialised chips for months.
</FunFact>
