...
<FunFact>
L’entraînement d’un modèle de langage de pointe peut coûter des centaines de millions de livres rien qu’en puissance de calcul. La boucle d’entraînement s’exécute sur des milliers de puces spécialisées pendant des mois.
</FunFact>
