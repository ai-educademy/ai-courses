...
<FunFact>
Le terme « apprentissage profond » signifie simplement un réseau de neurones avec beaucoup de couches cachées - plus de 2. Les grands modèles de langage actuels comptent des dizaines, voire plus d'une centaine de couches ! Plus de couches permettent d'apprendre des motifs de plus en plus abstraits : bords → formes → objets → scènes.
</FunFact>
