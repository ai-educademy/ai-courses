...
<FunFact>
L’œuvre complète de Shakespeare contient environ 900 000 mots. Les modèles de langage de pointe sont entraînés sur des jeux de données textuelles des milliers de fois plus grands - des centaines de milliards ou des milliers de milliards de mots, tous traités comme des chaînes avant d’être convertis en nombres.
</FunFact>
