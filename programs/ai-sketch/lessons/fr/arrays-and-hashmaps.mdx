...
Vous maîtrisez maintenant les deux outils de base du traitement des données en IA. Ensuite, dans **Chaînes de caractères et traitement de texte**, nous verrons comment l'IA transforme du texte brut en quelque chose qu'un modèle peut réellement lire, la première étape derrière chaque chatbot et chaque barre de recherche que vous utilisez.
