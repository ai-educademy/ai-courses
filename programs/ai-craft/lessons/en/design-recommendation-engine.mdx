...
<Illustration src="/images/lessons/craft/recommendation-types.svg" alt="Three-panel comparison of Collaborative Filtering (user similarity), Content-Based Filtering (item features), and Hybrid approach (ML-ranked combination) with pros, cons, and real-world usage" caption="Three approaches to recommendation — Collaborative finds patterns in user behaviour, Content-Based matches item features, and Hybrid combines both through an ML ranker for the best results." />
