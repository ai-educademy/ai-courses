...
description: "Explore the technical architecture behind AI Educademy: Next.js 15 App Router, next-intl for i18n, MDX content pipeline, git submodules, PWA support, and Vercel deployment."
date: "2026-03-06"
...
AI Educademy represents our commitment to accessible, performant, and maintainable tech infrastructure for education. If you're interested in any of these technologies or want to contribute, [our code is open source and waiting for your collaboration](https://github.com/aieducademy).
